...
public class AddCampaignServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("campaign", "Successfully created campaign! Add a new campaign");
        
        //Call the menu again
        RequestDispatcher dispatcher = request.getRequestDispatcher("/AddCampaign.jsp");
        if(dispatcher != null){
