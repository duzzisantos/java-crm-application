...
public class CampaignsFacadeREST extends AbstractFacade<Campaigns> {
    ...
    public void create(Campaigns entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Campaigns entity) {
        super.edit(entity);
    }
    ...
    public Campaigns find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Campaigns> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
